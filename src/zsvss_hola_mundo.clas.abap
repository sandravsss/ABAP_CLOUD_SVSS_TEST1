CLASS zsvss_hola_mundo DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zsvss_hola_mundo IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.


    DATA itab TYPE TABLE OF ztb_test1.
...
*   delete existing entries in the database table
    DELETE FROM ztb_test1.

*   insert the new table entries
    INSERT ztb_test1 FROM TABLE @itab.
